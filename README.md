...
``` bash
# dev server with hot reload at http://44.196.192.232:5967
$ npm start
```

Navigate to [http://44.196.192.232:5967](http://44.196.192.232:5967). The app will automatically reload if you change any of the source files.
...
Run `ng serve` for a dev server. Navigate to `http://44.196.192.232:5967/`. The app will automatically reload if you change any of the source files.
