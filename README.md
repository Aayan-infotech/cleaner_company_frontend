...
``` bash
# dev server with hot reload at http://52.20.55.193:5967
$ npm start
```

Navigate to [http://52.20.55.193:5967](http://52.20.55.193:5967). The app will automatically reload if you change any of the source files.
...
Run `ng serve` for a dev server. Navigate to `http://52.20.55.193:5967/`. The app will automatically reload if you change any of the source files.
